/*
 * OPC 省市二级选择器：34 个省级选项；离线数据，不在运行时请求外部服务。
 * 大陆基线：modood/Administrative-divisions-of-China，2023 年统计用区划数据。
 * 上游快照：c49d495b40ac73eb1a66f6eeae5f8fd10696f035；WTFPL v2。
 * 直辖市和港澳第二级为同名选项；台湾第二级为 22 县市，TW-* 为原型内部 ID。
 * 数据加工与核验：2026-09-10。不宣称为 2026 年最新官方行政区划数据。
 * 完整来源、转换口径及许可见同目录 china-regions-source.md。
 */
const CHINA_REGIONS = [
  {

const days = [
  ...
  {day:"D3",date:"9月28日",title:"阿勒泰 → 阿禾公路 → 禾木",roads:"阿勒泰 → 拉斯特乡 → G681阿禾公路 → 禾木游客中心",stay:"巴太咖啡·森林·下午茶美宿（禾木老村店）",group:"north",points:[[47.8450,88.1300],[47.9100,88.0400],[48.1700,87.7600],[48.3900,87.5500],[48.5750,87.4400]]},
  {day:"D4",date:"9月29日",title:"禾木晨景 → 贾登峪 → 喀纳斯",roads:"X852禾木公路 → 禾木岔路口 → S232喀布公路 → 贾登峪 → 景区区间车",stay:"贾登峪住宿（两家二选一）",group:"north",points:[[48.5750,87.4400],[48.5000,87.1300],[48.6900,87.0200],[48.5000,87.1300]]},
  {day:"D5",date:"9月30日",title:"贾登峪 → 铁贾公路 → 白哈巴",roads:"贾登峪 → 铁贾公路 → 铁热克提门票站 → 白哈巴新村停车场",stay:"归云民宿",group:"north",points:[[48.5000,87.1300],[48.3300,86.7800],[48.1800,86.5700],[48.0600,86.4200]]},
  {day:"D6",date:"10月1日",title:"白哈巴晨景 → 精河 · 纯转场",roads:"白哈巴 → 铁热克提 → G219/旅游专线 → 哈巴河县 → G331 → 布尔津 → G217/G3014 → G30连霍高速 → 精河",stay:"文华印象大酒店",group:"west",points:[[48.0600,86.4200],[48.0600,86.4300],[48.0500,86.4100],[47.7000,86.8600],[46.7500,86.0000],[45.5800,84.8900],[44.6000,82.8900]]},
...
const stops = [
  ...
  {name:"禾木",coord:[48.5750,87.4400],number:"3"},
  {name:"喀纳斯",coord:[48.6900,87.0200],number:"4"},
  {name:"白哈巴",coord:[48.0600,86.4200],number:"5"},
...
function showOverview(){
  ...
  document.querySelector("#summaryTitle").textContent="乌鲁木齐出发 · 北疆环线";

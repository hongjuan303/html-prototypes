...
const docs = {
  ...
  waterfall: `<h2>#页面说明</h2><ul><li>本页是绿台-产品运营-内容运营-瀑布流轮播图配置页。</li><li>统一配置官网首页轮播、优质作品及素材展览。</li></ul><h3>#原型说明</h3><p>支持图片与视频素材，并按国内版、海外版分别配置。</p><h4>● 修改记录</h4><p><span class="change-date">2026-08-04</span> <span class="change-copy">“爆款作品”统一调整为“优质作品”；新增国内/海外内容版本配置；类型新增“素材展览”。</span></p><h4>○ 筛选项</h4><ul><li><code>选择应用</code>：下拉单选，枚举“AI漫剧、其他”。</li><li><code>类型</code>：下拉单选，枚举“其他、首页轮播、优质作品、素材展览”。</li><li><code>内容版本</code>：下拉单选，枚举“国内、海外”。</li></ul><h4>○ 列表项</h4><ul><li>ID：添加素材后系统自动生成的唯一数字ID。</li><li>素材类型：图片或视频；视频展示第一帧及播放图标。</li><li>跳转方式：展示“不跳转”或网页链接。</li><li>开始时间、结束时间精确到分钟。</li><li>内容版本决定素材展示在国内版或海外版。</li></ul><h4>○ 操作项</h4><ul><li>添加/修改：打开居中弹窗。类型继承页面当前选择，不在弹窗重复填写。</li><li>选择优质作品时，额外展示“封面、热度”；热度用于官网热度值展示。</li><li>删除：弹出二次确认弹窗，确认后不可恢复。</li></ul>`
};
